...
document.getElementById("welcomeTextHelpPopup").innerHTML = "Bonjour! Puis-je vous aider? Sélectionnez 'Assistant digital' pour le bot 😍 ou les autres boutons pour communiquer avec nos conseillers ❤️" ;
...
let floatingBtn_kwds = document.getElementById("floatingBtn_kwds").value ;
  if (floatingBtn_kwds.length > 0) {
    ...
    themebM = "eczema" ;
    } else if (url.includes("dyshidrosis") && floatingBtn_kwds.includes("dyshidrose")) {
    themebM = "eczema" ;
    ...
    themebM = "maternite" ;
    } else if (url.includes("enceinte") && floatingBtn_kwds.includes("enceinte")) {
    themebM = "maternite" ;
