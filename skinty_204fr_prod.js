...
let skintypage_url = "https://skintifique.github.io/skinty/fr/index.html";
...
let floatingBtn_kwds = document.getElementById("floatingBtn_kwds").value ;
  if (floatingBtn_kwds.length > 0) {
    ...
    themebM = "eczema" ;
    } else if (url.includes("dyshidrosis") && floatingBtn_kwds.includes("dyshidros")) {
    themebM = "eczema" ;
    } else if (url.includes("psoriasis") && floatingBtn_kwds.includes("psoriasis")) {
    themebM = "psoriasis"
    } else if (url.includes("allergy") && floatingBtn_kwds.includes("allerg")) {
    themebM = "allergie" ;
    } else if (url.includes("maternity") && floatingBtn_kwds.includes("maternit")) {
    themebM = "maternite" ;
    } else if (url.includes("pregnan") && floatingBtn_kwds.includes("enceint")) {
    themebM = "maternite" ;
...
let target_urlM = skintypage_url + "?promb=" + prombM  + "&queryb=" + "&themeb=" + themebM + "&formatb=" + formatbM + "&showb=" + showbM ;
...
let themebM = x.value ;
let querybM = "" ;
let target_urlM = skintypage_url + "?promb=" + prombM  + "&queryb=" + querybM + "&themeb=" + themebM + "&formatb=" + formatbM + "&showb=" + showbM ;
document.getElementById("skintyframe").src = target_urlM ;
}
...
function skintyPage () {
document.getElementById("skintyframe").src = skintypage_url ;
}
