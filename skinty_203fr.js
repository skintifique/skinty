...
if ((showOnExit == "yes") &&
    ...
    let testOnOrderPage1 = urlForConditions3.includes("/commande") ;
...
let floatingBtn_kwds = document.getElementById("floatingBtn_kwds").value ;
  if (floatingBtn_kwds.length > 0) {
    ...
    themebM = "eczema" ;
    } else if (url.includes("dyshidrose") && floatingBtn_kwds.includes("dyshidrose")) {
    themebM = "eczema" ;
    } else if (url.includes("psoriasis") && floatingBtn_kwds.includes("psoriasis")) {
    themebM = "psoriasis"
    } else if (url.includes("allergy") && floatingBtn_kwds.includes("allergie")) {
    themebM = "allergie" ;
    } else if (url.includes("maternity") && floatingBtn_kwds.includes("maternit")) {
    themebM = "maternite" ;
    } else if (url.includes("pregnan") && floatingBtn_kwds.includes("enceinte")) {
    themebM = "maternite" ;
    } else if (url.includes("acne") && floatingBtn_kwds.includes("acne")) {
    themebM = "acne" ;
    } else if (url.includes("mature-skin") && floatingBtn_kwds.includes("peau-mature")) {
    themebM = "peau-mature" ;
    } else {
    themebM = "default" ; 
    } 
...
let target_urlM = "https://skintifique.github.io/fr/index.html" + "?promb=" + prombM  + "&queryb=" + "&themeb=" + themebM + "&formatb=" + formatbM + "&showb=" + showbM ;
...
let themebM = x.value ;
let querybM = "" ;
let target_urlM = "https://skintifique.github.io/fr/index.html" + "?promb=" + prombM  + "&queryb=" + querybM + "&themeb=" + themebM + "&formatb=" + formatbM + "&showb=" + showbM ;
document.getElementById("skintyframe").src = target_urlM ;
}
...
function skintyPage () {
document.getElementById("skintyframe").src = "https://skintifique.github.io/fr/index.html" ;
}
